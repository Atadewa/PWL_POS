        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <a href="{{ asset('template_excel/template_stok.xlsx') }}" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i>Download</a> 
                ...
                $.ajax({ 
                    ...
                    success: function(response) { 
                        if(response.status){ // jika sukses 
                            ...
                            dataStok.ajax.reload(null, false); // reload datatable 
                        } else{ // jika error 
                            $('.error-text').text(''); 
